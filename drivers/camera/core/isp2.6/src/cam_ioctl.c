		...
		unsigned long arg)
{
	...
	pr_debug("frame_addr_set sizeof=%zu ch=%u cnt=%u user_fid=%u sensor=%u fmt=%u\n",
		sizeof(struct sprd_img_parm), param.channel_id,
		param.buffer_count, param.user_fid, param.sensor_id,
		param.pixel_fmt);
