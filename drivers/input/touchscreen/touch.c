...
/* EEBBK A3: export the tp framework symbols for the modular FTS driver */
EXPORT_SYMBOL(tp_interface);
EXPORT_SYMBOL(mode_name);
EXPORT_SYMBOL(lcd_str);
EXPORT_SYMBOL(tp_create_sysfs);
EXPORT_SYMBOL(tp_remove_sysfs);
