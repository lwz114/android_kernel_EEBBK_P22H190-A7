...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-format-security \
		   -std=gnu89
# GCC 10/11 compatibility for the 4.14 code base (warnings treated as
# errors by -Werror above, but these are false positives on old code)
...
# GCC 10/11 printk format false positives on 4.14 code — downgrade to warnings
